...
// Server lists the equipments service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	List   http.Handler
	Get    http.Handler
...
// New instantiates HTTP handlers for all the equipments service endpoints
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"List", "GET", "/equipments"},
			{"Get", "GET", "/equipments/{inventory_number}"},
			{"Create", "POST", "/equipments"},
			{"Update", "PUT", "/equipments/{inventory_number}"},
			{"Delete", "DELETE", "/equipments/{inventory_number}"},
		},
...
func (s *Server) Service() string { return "equipments" }
...
func (s *Server) MethodNames() []string { return equipments.MethodNames[:] }

// Mount configures the mux to serve the equipments endpoints.
...
// MountListHandler configures the mux to serve the "equipments" service "list"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/equipments", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "equipments" service "list" endpoint.
func NewListHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "equipments")
...
// MountGetHandler configures the mux to serve the "equipments" service "get"
// endpoint.
func MountGetHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/equipments/{inventory_number}", f)
}

// NewGetHandler creates a HTTP handler which loads the HTTP request and calls
// the "equipments" service "get" endpoint.
func NewGetHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountCreateHandler configures the mux to serve the "equipments" service
// "create" endpoint.
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/equipments", f)
}

// NewCreateHandler creates a HTTP handler which loads the HTTP request and
// calls the "equipments" service "create" endpoint.
...
// MountUpdateHandler configures the mux to serve the "equipments" service
// "update" endpoint.
func MountUpdateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("PUT", "/equipments/{inventory_number}", f)
}

// NewUpdateHandler creates a HTTP handler which loads the HTTP request and
// calls the "equipments" service "update" endpoint.
...
// MountDeleteHandler configures the mux to serve the "equipments" service
// "delete" endpoint.
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/equipments/{inventory_number}", f)
}

// NewDeleteHandler creates a HTTP handler which loads the HTTP request and
// calls the "equipments" service "delete" endpoint.
