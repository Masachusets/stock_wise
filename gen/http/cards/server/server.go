...
// Server lists the cards service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	List   http.Handler
	Get    http.Handler
...
// New instantiates HTTP handlers for all the cards service endpoints using the
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"List", "GET", "/cards"},
			{"Get", "GET", "/cards/{number}"},
			{"Create", "POST", "/cards"},
			{"Update", "PUT", "/cards/{number}"},
			{"Delete", "DELETE", "/cards/{number}"},
		},
...
func (s *Server) Service() string { return "cards" }
...
func (s *Server) MethodNames() []string { return cards.MethodNames[:] }

// Mount configures the mux to serve the cards endpoints.
...
// MountListHandler configures the mux to serve the "cards" service "list"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/cards", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "cards" service "list" endpoint.
func NewListHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "cards")
		var err error
...
// MountGetHandler configures the mux to serve the "cards" service "get"
// endpoint.
...
// MountCreateHandler configures the mux to serve the "cards" service "create"
// endpoint.
...
// MountUpdateHandler configures the mux to serve the "cards" service "update"
// endpoint.
...
// MountDeleteHandler configures the mux to serve the "cards" service "delete"
// endpoint.
